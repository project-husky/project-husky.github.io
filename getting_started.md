...
[EPR Reference environment](https://github.com/ehealthsuisse/EPD-by-example/blob/main/files/gazelle.md#epr-reference-environment). This may provide a good starting point. You find a list of links to the code of the integrations tests for the basic transactions [here](./links_2_tests.md).
